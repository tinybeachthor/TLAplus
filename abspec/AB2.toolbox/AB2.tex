...
\@x{ {\CONSTANT} Data ,\, Bad}%
 ...
 ,\, 1 \}}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES} AVar ,\, BVar ,\, AtoB2 ,\, BtoA2}%
...
\@pvspace{8.0pt}%
 \@x{ Init\@s{8.00} \.{\defeq} \.{\land} AVar\@s{0.62} \.{\in} Data \.{\times}
 \{ 1 \}}%
\@x{\@s{43.71} \.{\land} BVar \.{=} AVar}%
\@x{\@s{43.71} \.{\land} AtoB2 \.{=} {\langle} {\rangle}}%
\@x{\@s{43.71} \.{\land} BtoA2\@s{0.77} \.{=} {\langle} {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ASnd \.{\defeq} \.{\land} AtoB2 \.{'} \.{=} Append ( AtoB2 ,\, AVar )}%
 \@x{\@s{43.71} \.{\land} {\UNCHANGED} {\langle} AVar ,\, BtoA2 ,\, BVar
 {\rangle}}%
 \@x{ BSnd\@s{0.39} \.{\defeq} \.{\land} BtoA2 \.{'} \.{=} Append ( BtoA2 ,\,
 BVar [ 2 ] )}%
 \@x{\@s{43.71} \.{\land} {\UNCHANGED} {\langle} AVar ,\, AtoB2 ,\, BVar
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ARcv\@s{0.32} \.{\defeq} \.{\land} BtoA2 \.{\neq} {\langle} {\rangle}}%
\@x{\@s{43.71} \.{\land} {\IF} Head ( BtoA2 ) \.{=} AVar [ 2 ]}%
\@x{\@s{66.97} \.{\THEN} \E\, d \.{\in} Data \.{:}}%
 \@x{\@s{111.65} AVar \.{'} \.{=} {\langle} d ,\, 1 \.{-} AVar [ 2 ]
 {\rangle}}%
\@x{\@s{66.97} \.{\ELSE} {\UNCHANGED} AVar}%
\@x{\@s{43.71} \.{\land} BtoA2 \.{'} \.{=} Tail ( BtoA2 )}%
\@x{\@s{43.71} \.{\land} {\UNCHANGED} {\langle} BVar ,\, AtoB2 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ BRcv\@s{0.72} \.{\defeq} \.{\land} AtoB2 \.{\neq} {\langle} {\rangle}}%
 \@x{\@s{43.71} \.{\land} {\IF} ( Head ( AtoB2 ) \.{\neq} Bad ) \.{\land} (
 Head ( AtoB2 ) [ 2 ] \.{\neq} BVar [ 2 ] )}%
\@x{\@s{66.97} \.{\THEN} BVar \.{'} \.{=} Head ( AtoB2 )}%
\@x{\@s{66.97} \.{\ELSE} {\UNCHANGED} BVar}%
\@x{\@s{43.71} \.{\land} AtoB2 \.{'} \.{=} Tail ( AtoB2 )}%
\@x{\@s{43.71} \.{\land} {\UNCHANGED} {\langle} AVar ,\, BtoA2 {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ CorruptMsg \.{\defeq} \.{\land} \.{\lor} \.{\land} \E\, i \.{\in} 1
 \.{\dotdot} Len ( AtoB2 ) \.{:}}%
 \@x{\@s{116.56} AtoB2 \.{'} \.{=} [ AtoB2 {\EXCEPT} {\bang} [ i ] \.{=} Bad
 ]}%
\@x{\@s{94.15} \.{\land} {\UNCHANGED} BtoA2}%
 \@x{\@s{83.03} \.{\lor} \.{\land} \E\, i \.{\in} 1 \.{\dotdot} Len ( BtoA2 )
 \.{:}}%
 \@x{\@s{116.56} BtoA2 \.{'} \.{=} [ BtoA2 {\EXCEPT} {\bang} [ i ] \.{=} Bad
 ]}%
\@x{\@s{94.15} \.{\land} {\UNCHANGED} AtoB2}%
...
\@x{\@s{16.4} {\IF} seq \.{=} {\langle} {\rangle}}%
\@x{\@s{32.65} \.{\THEN} {\langle} {\rangle}}%
\@x{\@s{32.65} \.{\ELSE} {\IF} Head ( seq ) \.{=} Bad}%
\@x{\@s{76.12} \.{\THEN} RemoveBad ( Tail ( seq ) )}%
 \@x{\@s{76.12} \.{\ELSE} {\langle} Head ( seq ) {\rangle} \.{\circ} RemoveBad
 ( Tail ( seq ) )}%
\@pvspace{8.0pt}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun \ensuremath{Nov} 17
 22:22:04 \ensuremath{CET} 2019 by \ensuremath{martin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sun \ensuremath{Nov} 17 19:29:22
 \ensuremath{CET} 2019 by \ensuremath{martin
}%
\end{cpar}%
\end{lcom}%
\end{document}
