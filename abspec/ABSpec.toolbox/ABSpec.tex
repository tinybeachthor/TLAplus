...
\@pvspace{8.0pt}%
 \@x{ Init\@s{2.02} \.{\defeq} \.{\land} AVar\@s{0.62} \.{\in} Data \.{\times}
 \{ 1 \}}%
\@x{\@s{37.72} \.{\land} BVar \.{=} AVar}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 Send a value from A
...
\@xx{}%
\@x{ A \.{\defeq} \.{\land} AVar \.{=} BVar}%
 \@x{\@s{26.32} \.{\land} \E\, d\@s{10.11} \.{\in} Data \.{:} AVar \.{'} \.{=}
 {\langle} d ,\, 1 \.{-} AVar [ 2 ] {\rangle}}%
\@x{\@s{26.32} \.{\land} {\UNCHANGED} BVar}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 Receive a value on \ensuremath{B
}}%
\@xx{}%
\@x{ B \.{\defeq} \.{\land} AVar \.{\neq} BVar}%
\@x{\@s{26.95} \.{\land} BVar \.{'} \.{=} AVar}%
\@x{\@s{26.95} \.{\land} {\UNCHANGED} AVar}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} A \.{\lor} B}%
\@pvspace{8.0pt}%
 \@x{ Spec\@s{1.46} \.{\defeq} Init \.{\land} {\Box} [ Next ]_{ {\langle} vars
 {\rangle}}}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 19:34:13 \ensuremath{CET} 2019 by \ensuremath{martin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sat \ensuremath{Nov} 16 19:26:21
