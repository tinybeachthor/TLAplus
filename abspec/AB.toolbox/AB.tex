...
\@pvspace{8.0pt}%
 ...
 \.{-} 1 ) \.{\mapsto}}%
\@x{\@s{104.74} {\IF} j \.{<} i \.{\THEN} seq [ j ]}%
\@x{\@s{138.82} \.{\ELSE} seq [ j \.{+} 1 ] ]}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES} AVar ,\, BVar ,\, AtoB ,\, BtoA}%
\@pvspace{8.0pt}%
...
\@x{\@s{43.71} \.{\land} AtoB\@s{0.43} \.{=} {\langle} {\rangle}}%
\@x{\@s{43.71} \.{\land} BtoA\@s{1.20} \.{=} {\langle} {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ASnd \.{\defeq} \.{\land} AtoB \.{'} \.{=} Append ( AtoB ,\, AVar )}%
 \@x{\@s{43.71} \.{\land} {\UNCHANGED} {\langle} AVar ,\, BtoA ,\, BVar
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ARcv\@s{0.32} \.{\defeq} \.{\land} BtoA \.{\neq} {\langle} {\rangle}}%
\@x{\@s{43.71} \.{\land} {\IF} Head ( BtoA ) \.{=} AVar [ 2 ]}%
\@x{\@s{66.97} \.{\THEN} \E\, d \.{\in} Data \.{:}}%
 \@x{\@s{111.65} AVar \.{'} \.{=} {\langle} d ,\, 1 \.{-} AVar [ 2 ]
 {\rangle}}%
\@x{\@s{66.97} \.{\ELSE} {\UNCHANGED} AVar}%
\@x{\@s{43.71} \.{\land} BtoA \.{'} \.{=} Tail ( BtoA )}%
\@x{\@s{43.71} \.{\land} {\UNCHANGED} {\langle} BVar ,\, AtoB {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ BSnd\@s{0.39} \.{\defeq} \.{\land} BtoA \.{'} \.{=} Append ( BtoA ,\,
 BVar [ 2 ] )}%
 \@x{\@s{43.71} \.{\land} {\UNCHANGED} {\langle} AVar ,\, AtoB ,\, BVar
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ BRcv\@s{0.72} \.{\defeq} \.{\land} AtoB \.{\neq} {\langle} {\rangle}}%
\@x{\@s{43.71} \.{\land} {\IF} Head ( AtoB ) [ 2 ] \.{\neq} BVar [ 2 ]}%
\@x{\@s{66.97} \.{\THEN} BVar \.{'} \.{=} Head ( AtoB )}%
\@x{\@s{66.97} \.{\ELSE} BVar \.{'} \.{=} BVar}%
\@x{\@s{43.71} \.{\land} AtoB \.{'} \.{=} Tail ( AtoB )}%
\@x{\@s{43.71} \.{\land} {\UNCHANGED} {\langle} AVar ,\, BtoA {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ LoseMsg \.{\defeq} \.{\land} \.{\lor} \.{\land} \E\, i \.{\in} 1
 \.{\dotdot} Len ( AtoB ) \.{:} AtoB \.{'} \.{=} Remove ( i ,\, AtoB )}%
...
\@pvspace{8.0pt}%
 \@x{ FairSpec \.{\defeq} Spec \.{\land} {\SF}_{ vars} ( ARcv )\@s{5.05}
 \.{\land} {\SF}_{ vars} ( BRcv ) \.{\land}}%
\@x{\@s{87.10} {\WF}_{ vars} ( ASnd ) \.{\land} {\WF}_{ vars} ( BSnd )}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
...
\@x{ {\THEOREM} FairSpec \.{\implies} ABS {\bang} FairSpec}%
\@pvspace{16.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sat \ensuremath{Nov} 16
 22:37:11 \ensuremath{CET} 2019 by \ensuremath{martin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sat \ensuremath{Nov} 16 21:47:38
