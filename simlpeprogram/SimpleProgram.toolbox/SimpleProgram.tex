...
\@x{ {\VARIABLES} i ,\, pc}%
\@pvspace{8.0pt}%
\@x{ Init\@s{6.36} \.{\defeq} \.{\land} pc \.{=}\@w{start}}%
\@x{\@s{42.06} \.{\land} i \.{=} 0}%
\@pvspace{8.0pt}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun \ensuremath{Sep} 22
 22:01:29 \ensuremath{CEST} 2019 by \ensuremath{martin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sun \ensuremath{Sep} 22 21:55:55
 \ensuremath{CEST} 2019 by \ensuremath{martin
}%
\end{cpar}%
\end{lcom}%
\end{document}
